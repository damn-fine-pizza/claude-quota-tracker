...
describe("mcp-http", () => {
  ...
  it("runs a real initialize -> tools/list -> get_quota_status session", async () => {
    ...
    expect(names).toEqual([
      "cancel_timer", "create_timer", "delete_task", "get_pacing_status", "get_quota_status", "get_routing_policy", "get_scheduler_status", "list_planner_receipts", "list_tasks", "list_timers",
